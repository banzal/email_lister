...
# Date: 06/15/2020
# Description: A simple python program which converts all entries in an
#              xlsx document which contains emails into a single CSV
...
df = pd.read_excel (r'School List.xlsx')
...
for col in df.columns:
    for val in df[col].dropna():
        # Normalize Unicode to utf-8 encoded string
...
print("All Data Successfully Converted to a CSV File!")